      ...
      <div className="wrapper" style={{ paddingLeft: "4rem", paddingRight: "4rem"}}>
        <section className="section section-lg section-safe">
          ...
          <div style={{ display: "flex", alignItems: "flex-start"}}>
            ...
            />
            <div>
              <h4 style={{ color: "#555b69" , marginTop: '15px'}}>Experience the future of e-voting with VoteChain - our customizable, secure voting app that offers convenience, transparency, and accessibility for all!</h4>
            ...
            {data.map((d) => (
              <div className="bg-white h-[500px] text-black rounded-xl">
                ...
                <div className="flex flex-col jusify-center items-center p-4">
                  <p className="text-xl font-semibold" style={{ color: "#8fac86" }}>{d.section}</p>
                  <p>{d.text}</p>
                </div>
              </div>
            ))}
